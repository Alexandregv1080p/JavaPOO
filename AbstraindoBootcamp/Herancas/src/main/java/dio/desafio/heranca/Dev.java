...
public class Dev {
    private String nome;
    Set<Conteudo> conteudosInscritos = new LinkedHashSet<>(); //o linked só permite conteudos unicos
    Set<Conteudo> conteudosConcluidos = new LinkedHashSet<>();

    public void inscreverBootcamp(Bootcamp bootcamp){
        this.conteudosInscritos.addAll(bootcamp.getConteudos());
        bootcamp.getDevsInscritos().add(this); //adicionamos o dev no bootcamp de devinscritos
    }
